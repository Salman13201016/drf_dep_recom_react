...
from .views import MenuListCreateAPIView, MenuRetrieveUpdateDestroyAPIView, MenuPermissionCreateAPIView, SubmenuCreateAPIView, MenuPermissionListCreateAPIView
urlpatterns = [
